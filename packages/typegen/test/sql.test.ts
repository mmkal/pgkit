  ...
  expect(syncer.yaml()).toMatchInlineSnapshot(`
    ...
    __sql__: 
      test-table1.sql.ts: |-
        ...
        }: GetTestTable1QuerySyncOptions = {}): TaggedTemplateLiteralInvocation<TestTable1> => ({
        ...
        }: GetTestTable1QueryAsyncOptions = {}): Promise<TaggedTemplateLiteralInvocation<TestTable1>> => ({
      ...
      test-table2.sql.ts: |-
        ...
        export const getTestTable2QuerySync = ({
          readFileSync = defaultReadFileSync,
        }: GetTestTable2QuerySyncOptions = {}): TaggedTemplateLiteralInvocation<TestTable2> => ({
          sql: readFileSync(sqlPath).toString(),
          type: 'SLONIK_TOKEN_SQL',
          values: [],
        })
        ...
        export const getTestTable2QueryAsync = async ({
          readFile = defaultReadFileAsync,
        }: GetTestTable2QueryAsyncOptions = {}): Promise<TaggedTemplateLiteralInvocation<TestTable2>> => ({
          sql: (await readFile(sqlPath)).toString(),
          type: 'SLONIK_TOKEN_SQL',
          values: [],
        })
    ...
    __sql__: 
      test-table.sql.ts: |-
        ...
        export const getTestTableQuerySync = ({
          readFileSync = defaultReadFileSync,
          params,
        }: GetTestTableQuerySyncOptions): TaggedTemplateLiteralInvocation<TestTable> => ({
          sql: readFileSync(sqlPath).toString(),
          type: 'SLONIK_TOKEN_SQL',
        ...
        export const getTestTableQueryAsync = async ({
          readFile = defaultReadFileAsync,
          params,
        }: GetTestTableQueryAsyncOptions): Promise<TaggedTemplateLiteralInvocation<TestTable>> => ({
          sql: (await readFile(sqlPath)).toString(),
          type: 'SLONIK_TOKEN_SQL',
          values: [params['$1'], params['$2']],
        })
