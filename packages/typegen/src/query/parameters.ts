...
if (require.main === module) {
  ...
  parameterTypesGetter(
    require('@pgkit/client').createClient('postgresql://postgres:postgres@localhost:5432/postgres'),
  )(`select * from gdesc_test.test_table`).then(console.log, console.error)
}
