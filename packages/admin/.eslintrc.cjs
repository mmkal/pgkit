...
module.exports = {
  ...
  rules: {
    'jsx-quotes': 'off', // mmkal
    'mmkal/@typescript-eslint/no-non-null-asserted-optional-chain': 'off', // mmkal
    'object-shorthand': 'off', // mmkal
    'mmkal/unicorn/explicit-length-check': 'off', // mmkal
